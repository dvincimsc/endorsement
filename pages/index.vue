  ...
  <div class="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-10">
    <div class="bg-white shadow-xl rounded-2xl p-6 w-full max-w-xl space-y-5">
      ...
      >
        ...
        <option value="SOC 5">SOC 5 - Univation Parking</option>
      ...
      <button
        ...
        :disabled="loading"
        :class="[
          'w-full py-2 rounded-lg transition cursor-pointer',
          loading
...
async function generateDocument() {
  ...
  try {
    ...
    const formattedNames = names.value
      .split(',')
      .map(n => n.trim())
      .join(', ')
